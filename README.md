...
<!-- The Elite Dangerous badge embeds the logo as a base64 data URI, which is why
     it is a very long line. Reference-style so it stays out of the way.
     Logo: https://edassets.org/ — Frontier's trademark, used for identification
     only; see the unofficial-tool note above. -->
